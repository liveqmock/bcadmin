      ...
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column label="操作" width="180">
          <template scope="scope">
            ...
            <el-button v-show="scope.row.status === '已支付' && scope.row.paid > 0" type="warning" size="small" @click="refundTicket(scope.row.id)">申请退款</el-button>
...
<script>
  ...
  export default {
    ...
    computed: {
      exportLink () {
        return URL.api_name + 'backofficeapi/order/export-by-store-id.do' +
