  ...
  <div class="list">
      ...
      <el-form :inline="true" :model="formInline" class="demo-form-inline">
        ...
        <el-form-item label="退款类型：">
          <el-select v-model="formInline.refundType" placeholder="请选择">
            <el-option label="票" value="P"></el-option>
            <el-option label="缴费" value="G"></el-option>
            <el-option label="商品" value="S"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item>
    ...
    <div class="table-data"
      ...
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column prop="updateBy" label="审批人">
        </el-table-column>
