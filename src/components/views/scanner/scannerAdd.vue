  ...
  <div class="add-coupon">
    <div class="crumbs">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>添加扫描器</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="form-data">
      <el-form label-width="120px" :model="formData" :rules="rules" ref="formData">
        ...
        <el-form-item label="类型:" prop="inOrOut">
          <el-col :span="12">
            <el-select v-model="formData.inOrOut">
      ...
      methods: {
        ...
        onSubmit (name) {
          ...
          that.$refs[name].validate((valid) => {
            if (valid) {
              that.loading = true
              axios.post(URL.api_name + 'backofficeapi/gatescanner/add.do', that.formData).then(res => {
                if (res.data.status === 'success') {
                  that.$message({
                    type: 'success',
                    message: '添加成功',
