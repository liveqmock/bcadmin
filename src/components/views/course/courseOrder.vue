  ...
  <div class="list">
    ...
    <div class="search-wrapper">
      <el-form :inline="true" :model="formInline" class="demo-form-inline">
        ...
        <el-form-item>
          ...
          <el-button type="primary" @click="getFirstCourse">首次上课学员</el-button>
        </el-form-item>
      </el-form>
    </div>
    <div class="tabPane">
      <a href="javascript:;" class="tabChange current">正常订单</a>
      <a href="javascript:;" class="tabChange" @click="goNext1">异常订单</a>
    ...
    <div class="table-data courseData"
      ...
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column prop="salesName" label="销售顾问">
        </el-table-column>
        <el-table-column prop="consultantName" label="课程顾问">
        </el-table-column>
        ...
        <el-table-column label="操作" width="200">
          <template scope="scope">
            <el-button type="info" size="small" v-show="scope.row.maxnum > scope.row.curnum && scope.row.curnum > 0" @click="checkAddStudent(scope.row.courseCoachId)">加入学员</el-button>
            <!-- <el-button type="info" size="small" @click="">开课</el-button> -->
            <el-button
              v-show="scope.row.memberList.length > 0"
              type="info" size="small" @click="updateOne(scope.row.courseCoachId)">调课</el-button>
            <el-button
              v-show="scope.row.memberList.length > 0"
              type="info" size="small" @click="changeOne(scope.row.courseCoachId)">退本周课</el-button>
            <el-button
              v-show="scope.row.memberList.length > 0"
              type="info" size="small" @click="changeAll(scope.row.courseCoachId)">退所有课</el-button>
            <el-button
              v-show="scope.row.memberList.length > 0"
...
//              })
      ...
      changeOne (courseCoachId) {
        this.$router.push({
          path: '/changeOneCourse/' + courseCoachId
        })
      },
      updateOne (courseCoachId) {
        this.$router.push({
