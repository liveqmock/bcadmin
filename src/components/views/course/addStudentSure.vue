      ...
      submitOrder () {
        ...
        axios.post(URL.api_name + 'backofficeapi/course/buy/purchase.do', {
          ...
          if (res.data.status === 'success') {
            ...
            this.$router.push({
              path: '/addStudentPay/' + that.$route.params.courseCoachId + '/' + that.$route.params.courseId + '/' + that.$route.params.courseLevel + '/' + res.data.data.orderId + '/' + res.data.data.orderPaidPrice + '/' + res.data.data.orderTotalPrice + '/' + that.$route.params.memberId
            })
          } else {
