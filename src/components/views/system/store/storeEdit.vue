    ...
    <div class="form-data">
      <el-form label-width="100px" :model="formData" ref="formData" :rules="rules">
        ...
        <!--<el-form-item label="门店编码:" required prop="storeCode">
          <el-row>
            <el-col :span="12">
              <el-input type="text" v-model="formData.storeCode" :disabled="true" placeholder="请输入门店编码"></el-input>
            </el-col>
          </el-row>
        </el-form-item>-->
    ...
    methods: {
      addOrg (formName) {
        ...
        that.$refs[formName].validate((valid) => {
          if (valid) {
            that.loading = true
            axios.post(URL.api_name + 'backofficeapi/store/update.do', this.formData).then((res) => {
              that.loading = false
