  ...
  <div class="coupon-count">
    <div class="crumbs">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>售票收入统计</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="search-wrapper">
      <el-form :inline="true" :model="formInline" class="demo-form-inline">
        ...
        <el-form-item label="票据类型">
          <el-select v-model="formInline.type_sp">
            <el-option label="全部" value=""></el-option>
    ...
    <div class="table-data"
      ...
      <el-table :data="tableData" border style="width: 100%">
        <el-table-column prop="name" label="序号" width="88" fixed="left">
        ...
        <el-table-column prop="type_sp" label="票据类型">
        </el-table-column>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      exportLink () {
        return URL.api_name + 'backofficeapi/statisticsincome/sp/export.do?' +
          'years=' + this.chooseYear + '&type_sp=' + this.formInline.type_sp +
          '&store_name=' + this.formInline.store_name + '&address=' + this.address
      }
    },
    data () {
      return {
    ...
    methods: {
      ...
      getListData (num) {
        ...
        var that = this
        that.loading = true
        axios.get(URL.api_name + 'backofficeapi/statisticsincome/splist.do', {
          params: {
            ...
            type_sp: this.formInline.type_sp,
